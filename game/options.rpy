...
define config.name = _("Mull Aja Meres")
...
define build.name = "MullAjaMeres"
...
define config.end_game_transition = Dissolve(2) #note capitol D
...
define config.save_directory = "Alphademo-1686417027"
